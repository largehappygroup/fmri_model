...
%--------------------------------------------------------------------------
    ...
    wrw = wr(1).name;
        ...
        matlabbatch{1}.spm.spatial.realignunwarp.data(1).scans  = cellstr(strcat([pwd '/' wrw '/func/rest/run_01/'], ...
                                                                    spm_select('List', [pwd '/' wrw '/func/rest/run_01/'], '^run*.*nii$')));
        matlabbatch{1}.spm.spatial.realignunwarp.data(1).pmscan = cellstr(strcat([pwd '/' wrw '/func/rest/run_01/'], ...
                                                                    spm_select('List', [pwd '/' wrw '/func/rest/run_01/'], '^vdm5_fpm0000.*img$')));
        
    % Now grab the remaining EPIs.

    for iRun = 1:nRun
                
        matlabbatch{1}.spm.spatial.realignunwarp.data(iRun+1).scans  = cellstr(strcat([pwd '/' wrw '/func/typing/run_0' num2str(iRun) '/'], ...
                                                                        spm_select('List', [pwd '/' wrw '/func/typing/run_0' num2str(iRun) '/'], '^run*.*nii$')));
        matlabbatch{1}.spm.spatial.realignunwarp.data(iRun+1).pmscan = cellstr(strcat([pwd '/' wrw '/func/typing/run_0' num2str(iRun) '/'], ...
                                                                        spm_select('List', [pwd '/' wrw '/func/typing/run_0' num2str(iRun) '/'], '^vdm5_fpm0000.*img$')));
...
%--------------------------------------------------------------------------
    ...
    mkdir(['./' wrw '/func/mean']);
    	movefile(strcat([pwd '/' wrw '/func/rest/run_01/meanurun*']), strcat([pwd '/' wrw '/func/mean']));
...
% much a subject moved during each scan.
    ...
    % Obtain realignment parameters.    
        ...
        rpData = load(strcat([pwd '/' wrw '/func/rest/run_01/'], ...
                        spm_select('List', [pwd '/' wrw '/func/rest/run_01'], 'rp_run_01.txt')));
    ...
    % Loop over the remaining EPIs.
        ...
        for iRun = 1:nRun
            ...
            % Obtain realignment parameters.    
                ...
                rpData = load(strcat([pwd '/' wrw '/func/typing/run_0' num2str(iRun) '/'], ...
                                spm_select('List', [pwd '/' wrw '/func/typing/run_0' num2str(iRun) '/'], ['^rp_run*.*txt$'])));
